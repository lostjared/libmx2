...
namespace html {
    ...
    void gen_html(std::ostream& out, const std::shared_ptr<cmd::Node>& node) {
        ...
        out << "    }\n";
        out << "    .node h3:hover::before {\n";
        out << "      color: var(--accent-secondary);\n";
        out << "    }\n";
        out << "  </style>\n";
        out << "  <script>\n";
        ...
        out << "          if (content) {\n";
        out << "            const isVisible = content.style.display !== 'none';\n";
        out << "            content.style.display = isVisible ? 'none' : 'block';\n";
        out << "            this.classList.toggle('collapsed', isVisible);\n";
        out << "            if (isVisible) {\n";
        out << "              this.style.setProperty('--rotate', '270deg');\n";
        out << "            } else {\n";
        out << "              this.style.setProperty('--rotate', '0deg');\n";
        out << "            }\n";
        out << "          }\n";
        out << "        });\n";
        out << "      });\n";

...
public:
    ...
    void load(gl::GLWindow *win) {
        ...
        const char *vertexShader = R"(
            ...
            out vec2 TexCoord;
            out vec3 FragPos;  // Add FragPos for fog calculation
...
const char *fragmentShader = R"(#version 300 es
    ...
    void draw(gl::GLWindow *win) {
        ...
        GLuint fogColorLoc = glGetUniformLocation(floorShader.id(), "fogColor");
        GLuint fogDensityLoc = glGetUniformLocation(floorShader.id(), "fogDensity");
        GLuint viewPosLoc = glGetUniformLocation(floorShader.id(), "viewPos");
    ...
    void load(gl::GLWindow *win) {
        ...
        const char *fragmentShader = R"(
            ...
            void main() {
                ...
                FragColor = mix(vec4(fogColor, texColor.a), vec4(result, texColor.a), fogFactor);
            }
        )";
#else
const char *vertexShader = R"(#version 300 es
...
const char *fragmentShader = R"(#version 300 es
    ...
    void draw(gl::GLWindow *win, const glm::mat4& view, const glm::mat4& projection, const glm::vec3& cameraPos) {
        ...
        GLuint fogColorLoc = glGetUniformLocation(obj_shader.id(), "fogColor");
        GLuint fogDensityLoc = glGetUniformLocation(obj_shader.id(), "fogDensity");

...
layout(binding = 1) uniform UniformBufferObject {
    ...
    mat4 view;
    mat4 proj;
    vec4 params;   // params.x = time, params.y = width, params.z = height
    vec4 color;    // can be used for mouse: color.xy = mouse pos, color.z = mouse button
} ubo;

// Derived uniforms from UBO
#define iResolution vec2(ubo.params.y, ubo.params.z)
#define time_f ubo.params.x
#define iMouse ubo.color

...
$(OUTPUT): $(OBJECTS)
	$(CXX) $(CXXFLAGS) $(OBJECTS) -o $(OUTPUT) $(PRELOAD)  -s USE_SDL=2 -s USE_SDL_TTF=2 $(LIBMX_LIB) $(PNG_LIB) $(ZLIB_LIB) -sASSERTIONS -s ALLOW_MEMORY_GROWTH -s USE_WEBGL2=1 -s FULL_ES3 -s USE_SDL_MIXER=2
